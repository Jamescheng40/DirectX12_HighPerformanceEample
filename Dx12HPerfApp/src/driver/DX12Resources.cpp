#include "..\..\inc\driver\DX12Resources.h"
	...
	, m_d3d12Device(device)	
{
	...
	assert(m_FenceEvent && "Failed to create event handle");
...
Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList2> CommandQueue::GetCommandList()
{
	...
	//ID3D12GraphicsCommandList2 can be replaced to ID3D12GraphicsCommandList for older version
...
{
	return (m_d3d12Fence->GetCompletedValue() >= fenceValue ? true : false);
}
